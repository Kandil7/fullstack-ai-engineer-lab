...
from devmate.index.vector_store import BaseVectorStore, SearchResult, get_vector_store
...
class CohereReranker(BaseReranker):
    ...
    def __init__(self, api_key: str = None, model: str = "rerank-v3.5") -> None:
...
async def get_retriever() -> Retriever:
    ...
    if _retriever_instance is None:
        ...
        reranker = (
            get_reranker("cohere", api_key=cohere_key) if cohere_key else get_reranker("none")
        )
