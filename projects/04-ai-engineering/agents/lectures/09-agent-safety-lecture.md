...
class SafetyGuardrail:
    ...
    def add_approval_callback(self, action_type: str, callback: Callable):
    ...
    def validate_action(self, action: AgentAction) -> Dict:
        ...
        return {
            ...
            "requires_approval": action.risk_level
    ...
    def _check_rate_limit(self, action_name: str) -> bool:
        ...
        # Remove old entries
        self.action_counts[action_name] = [
            t for t in self.action_counts[action_name] if now - t < 60
        ]
    ...
    def filter_content(self, content: str) -> Dict:
        ...
        return {"safe": len(issues) == 0, "filtered": filtered, "issues": issues}
...
class SafeAgent:
    ...
    def execute_action(self, action: AgentAction) -> Dict:
        ...
        if not validation["allowed"]:
            return {"executed": False, "result": None, "issues": [validation["reason"]]}
        ...
        try:
            ...
            return {"executed": True, "result": result, "issues": []}
        except Exception as e:
