...
surf2 = ax2.plot_surface(
    X, Y, Z2, cmap="RdYlBu", alpha=0.8, rstride=2, cstride=2, linewidth=0, antialiased=True
)
...
surf4 = ax4.plot_surface(
    X, Y, Z, cmap="coolwarm", alpha=0.6, rstride=1, cstride=1, linewidth=0, antialiased=True
)
...
ax4.plot_surface(
    x_sphere, y_sphere, z_sphere, facecolors=colors, rstride=1, cstride=1, alpha=0.8, shade=False
)
