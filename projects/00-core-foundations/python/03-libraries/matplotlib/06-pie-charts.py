...
plt.tight_layout()
plt.savefig('output/pie_basic.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/pie_custom.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/polar_plots.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/radar_charts.png', dpi=150)
plt.close()
