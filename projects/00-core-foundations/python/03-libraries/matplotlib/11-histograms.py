...
def exercise_01():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, "11_exercise_01.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_02():
    ...
    plt.xlabel("Value")
    plt.ylabel("Density")
    plt.savefig(os.path.join(OUTPUT_DIR, "11_exercise_02.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_03():
    ...
    plt.xlabel("Score")
    plt.ylabel("Frequency")
    plt.savefig(os.path.join(OUTPUT_DIR, "11_exercise_03.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_04():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, "11_exercise_04.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_05():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig(os.path.join(OUTPUT_DIR, "11_exercise_05.png"), dpi=100, bbox_inches="tight")
    plt.close()
