...
def exercise_01():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig(os.path.join(OUTPUT_DIR, "15_exercise_01.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_02():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig(os.path.join(OUTPUT_DIR, "15_exercise_02.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_03():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig(os.path.join(OUTPUT_DIR, "15_exercise_03.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_04():
    ...
    plt.xlabel("X (km)")
    plt.ylabel("Y (km)")
    plt.savefig(os.path.join(OUTPUT_DIR, "15_exercise_04.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_05():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig(os.path.join(OUTPUT_DIR, "15_exercise_05.png"), dpi=100, bbox_inches="tight")
    plt.close()
