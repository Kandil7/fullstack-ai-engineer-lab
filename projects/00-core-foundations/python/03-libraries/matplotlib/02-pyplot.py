...
def exercise_01():
    ...
    plt.xlabel("x")
    plt.ylabel("y")
    plt.savefig(os.path.join(OUTPUT_DIR, "02_exercise_01.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_02():
    ...
    plt.xlabel("Index")
    plt.ylabel("Value")
    plt.savefig(os.path.join(OUTPUT_DIR, "02_exercise_02.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_03():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, "02_exercise_03.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_04():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, "02_exercise_04.png"), dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_05():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "02_exercise_05.png"), dpi=100, bbox_inches="tight")
    plt.close()
