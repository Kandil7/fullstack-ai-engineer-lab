...
plt.tight_layout()
plt.savefig('output/scatter_basic.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/scatter_colormap.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/scatter_bubble.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/scatter_density.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('output/scatter_annotated.png', dpi=150)
plt.close()
