...
def exercise_01():
    ...
    ax.set_ylabel("Y")
    ax.set_zlabel("Z")
    plt.savefig("../../../outputs/matplotlib/16_exercise_01.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_02():
    ...
    plt.tight_layout()
    plt.savefig("../../../outputs/matplotlib/16_exercise_02.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_03():
    ...
    ax.set_ylabel("Y")
    ax.set_zlabel("Z")
    plt.savefig("../../../outputs/matplotlib/16_exercise_03.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_04():
    ...
    plt.savefig("../../../outputs/matplotlib/16_exercise_04.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_05():
    ...
    ax.set_ylabel("Y")
    ax.set_zlabel("Z")
    plt.savefig("../../../outputs/matplotlib/16_exercise_05.png", dpi=100, bbox_inches="tight")
    plt.close()
