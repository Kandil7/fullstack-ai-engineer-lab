...
def exercise_01():
    ...
    plt.xlabel("X values")
    plt.ylabel("Y values")
    plt.savefig("../../../outputs/matplotlib/09_exercise_01.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_02():
    ...
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.savefig("../../../outputs/matplotlib/09_exercise_02.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_03():
    ...
    plt.legend()
    plt.savefig("../../../outputs/matplotlib/09_exercise_03.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_04():
    ...
    plt.savefig("../../../outputs/matplotlib/09_exercise_04.png", dpi=100, bbox_inches="tight")
    plt.close()
...
def exercise_05():
    ...
    plt.ylabel("Y")
    plt.grid(True, alpha=0.3)
    plt.savefig("../../../outputs/matplotlib/09_exercise_05.png", dpi=100, bbox_inches="tight")
    plt.close()
