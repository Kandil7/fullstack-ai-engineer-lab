...
df = pd.DataFrame(
    {
        ...
        "city": np.random.choice(
            ["NYC", "SF", "LA", "Chicago", "Austin", "Seattle", "Boston"], 100
        ),
        ...
        "skills": [
            ",".join(
                np.random.choice(
                    ["Python", "SQL", "Java", "AWS", "Docker", "K8s", "React", "ML"],
...
result = df.eval(
    'salary > 100000 and department in ["Eng", "Sales"] and age < 40 and not is_manager'
)
