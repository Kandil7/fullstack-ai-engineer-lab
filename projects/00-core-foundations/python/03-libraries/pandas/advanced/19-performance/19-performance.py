...
left = pd.DataFrame({"key": np.random.randint(0, 10000, 50000), "val1": np.random.randn(50000)})

right = pd.DataFrame({"key": np.random.randint(0, 10000, 50000), "val2": np.random.randn(50000)})
