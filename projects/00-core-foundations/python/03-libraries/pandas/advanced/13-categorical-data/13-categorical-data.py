...
ordered_cat = pd.Categorical(
    ["low", "medium", "high", "low", "high"], categories=["low", "medium", "high"], ordered=True
)
...
df_train = pd.DataFrame(
    {"category": ["A", "A", "A", "B", "B", "B", "C", "C"], "target": [1, 0, 1, 0, 0, 1, 1, 1]}
)
...
ordinal = OrdinalEncoder(
    categories=[["S", "M", "L"], ["cotton", "silk", "wool"], ["blue", "green", "red"]]
)
