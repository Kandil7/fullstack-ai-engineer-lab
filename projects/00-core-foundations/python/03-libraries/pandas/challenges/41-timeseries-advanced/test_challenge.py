...
class TestNoLeakRolling:
    ...
    def test_window_two(self) -> None:
        ...
        assert result.iloc[2] == 15.0, "row 2 must be the mean of rows 0..1 = 15.0"
...
class TestBuildFeatures:
    ...
    def test_known_values(self) -> None:
        s = pd.Series(
            [10.0, 20.0, 30.0, 50.0], index=pd.date_range("2024-01-01", periods=4, freq="D")
        )
        ...
        assert np.allclose(feats["pct_chg"].iloc[1:].tolist(), [1.0, 0.5, 2.0 / 3.0])
