...
plt.tight_layout()
plt.savefig("scipy_06_1d_interp.png", dpi=100)
print("Plot saved: scipy_06_1d_interp.png")
...
plt.tight_layout()
plt.savefig("scipy_06_spline.png", dpi=100)
print("Plot saved: scipy_06_spline.png")
...
axes[0].set_title("Coarse Grid (8×8)")
...
plt.tight_layout()
plt.savefig("scipy_06_2d_interp.png", dpi=100)
print("Plot saved: scipy_06_2d_interp.png")
...
plt.tight_layout()
plt.savefig("scipy_06_rbf.png", dpi=100)
print("Plot saved: scipy_06_rbf.png")
...
ax.set_title("Data Resampling: Irregular → Regular Grid")
ax.set_xlabel("Time")
ax.set_ylabel("Value")
ax.legend()
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("scipy_06_resample.png", dpi=100)
print("Plot saved: scipy_06_resample.png")
