# Django Lecture 18: Pagination

## 🎯 Topic Overview

Pagination — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django pagination concepts
2. Implement pagination in Django projects
...
This lecture covers pagination in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
`Paginator(object_list, per_page)` — splits a list into pages.

### 2. Page Object

`.page(number)` returns a Page. `.has_previous()`, `.has_next()`, `.number`.

### 3. ListView Pagination

Set `paginate_by = 10` on ListView for automatic pagination.

### 4. Template Pagination

Loop over `page_obj.paginator.page_range` for page navigation links.
...
Create a Django app that implements the pagination concept covered in this lecture. Include proper URL routing and template rendering.
