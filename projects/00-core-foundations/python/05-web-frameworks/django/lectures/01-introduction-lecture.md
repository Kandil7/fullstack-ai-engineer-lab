# Django Lecture 01: Introduction to Django

## 🎯 Topic Overview

Introduction to Django — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django introduction to django concepts
2. Implement introduction to django in Django projects
...
This lecture covers introduction to django in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
High-level Python web framework. 'Batteries included' with ORM, auth, admin, templating.

### 2. MVT Pattern

Model (data), View (logic), Template (presentation). Django's variant of MVC.

### 3. Django vs Flask vs FastAPI

Django is full-featured. Flask is minimal. FastAPI is async-first.

### 4. Project Structure

manage.py, settings.py, urls.py, wsgi.py define the project skeleton.
...
Create a Django app that implements the introduction to django concept covered in this lecture. Include proper URL routing and template rendering.
