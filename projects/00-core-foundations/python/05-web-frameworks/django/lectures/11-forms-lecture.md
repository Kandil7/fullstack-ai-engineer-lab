# Django Lecture 11: Django Forms

## 🎯 Topic Overview

Django Forms — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django django forms concepts
2. Implement django forms in Django projects
...
This lecture covers django forms in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
`class ContactForm(forms.Form):` defines form fields and validation.

### 2. Form Fields

CharField, EmailField, IntegerField, ChoiceField, BooleanField, DateField.

### 3. Validation

clean(), clean_fieldname() methods for custom validation logic.

### 4. Forms in Templates

`{{ form.as_p }}`, `{{ form.as_table }}`, `{{ form.as_ul }}` for rendering.
...
Create a Django app that implements the django forms concept covered in this lecture. Include proper URL routing and template rendering.
