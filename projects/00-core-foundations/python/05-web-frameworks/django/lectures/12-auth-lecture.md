# Django Lecture 12: Authentication

## 🎯 Topic Overview

Authentication — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django authentication concepts
2. Implement authentication in Django projects
...
This lecture covers authentication in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
Built-in User model with username, password, email, first_name, last_name.

### 2. Login/Logout

`login(request, user)` and `logout(request)` from django.contrib.auth.
...
`User.objects.create_user(username, email, password)` hashes password automatically.
...
Create a Django app that implements the authentication concept covered in this lecture. Include proper URL routing and template rendering.
