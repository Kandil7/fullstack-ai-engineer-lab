# Django Lecture 03: Django Apps

## 🎯 Topic Overview

Django Apps — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django django apps concepts
2. Implement django apps in Django projects
...
This lecture covers django apps in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
`python manage.py startapp blog` creates a reusable app module.

### 2. App Structure

models.py, views.py, urls.py, admin.py, apps.py, tests.py, migrations/.

### 3. INSTALLED_APPS

Register apps in settings.py: `INSTALLED_APPS = ['blog.apps.BlogConfig']`.

### 4. App vs Project

A project is a website. An app is a feature module within the project.
...
Create a Django app that implements the django apps concept covered in this lecture. Include proper URL routing and template rendering.
