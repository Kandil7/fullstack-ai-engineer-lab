# Django Lecture 14: CSRF Protection

## 🎯 Topic Overview

CSRF Protection — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django csrf protection concepts
2. Implement csrf protection in Django projects
...
This lecture covers csrf protection in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
Cross-Site Request Forgery — tricking a user into making unintended requests.

### 2. CSRF Token

Django includes a CSRF token in forms: `{% csrf_token %}`.

### 3. AJAX and CSRF

Include CSRF token in X-CSRFToken header for AJAX requests.

### 4. CSRF_TRUSTED_ORIGINS

List of trusted origins for cross-origin POST requests.
...
Create a Django app that implements the csrf protection concept covered in this lecture. Include proper URL routing and template rendering.
