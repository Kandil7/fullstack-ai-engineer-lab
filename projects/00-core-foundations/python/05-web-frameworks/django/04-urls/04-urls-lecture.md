# Django Lecture 04: URL Routing

## 🎯 Topic Overview

URL Routing — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django url routing concepts
2. Implement url routing in Django projects
...
This lecture covers url routing in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
List of URL patterns: `path('admin/', admin.site.urls)`.

### 2. path() vs re_path()

path uses simple routing. re_path uses regular expressions.

### 3. URL Parameters

`path('article/<int:id>/', views.detail)` captures URL parameters.

### 4. include()

`path('blog/', include('blog.urls'))` delegates to app-level URL configs.
...
Create a Django app that implements the url routing concept covered in this lecture. Include proper URL routing and template rendering.
