# Django Lecture 16: Model Relationships

## 🎯 Topic Overview

Model Relationships — essential Django concept for building web applications.

## 📚 Learning Objectives

By the end of this lecture, you will be able to:
1. Understand Django model relationships concepts
2. Implement model relationships in Django projects
...
This lecture covers model relationships in Django. Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing built-in tools for common web development tasks.
...
Many-to-one relationship. Creates a database column with _id suffix.

### 2. ManyToManyField

Many-to-many relationship. Creates a junction table.

### 3. OneToOneField

One-to-one relationship. Like ForeignKey with unique=True.

### 4. related_name

Reverse relation name. `related_name='posts'` allows `author.posts.all()`.
...
Create a Django app that implements the model relationships concept covered in this lecture. Include proper URL routing and template rendering.
