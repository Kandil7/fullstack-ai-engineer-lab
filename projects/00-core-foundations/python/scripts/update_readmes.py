...
for numbered exercise directories. Also generates INDEX.md files.

Usage:
    python scripts/update_readmes.py                     # Preview changes
    python scripts/update_readmes.py --write             # Apply changes
...
def generate_index(dirpath: str, write: bool = False) -> bool:
...
def main():
    ...
    for d in dirs:
        if args.index:
            if generate_index(d, write=args.write):
                updated += 1
        else:
