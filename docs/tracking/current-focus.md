...
**Duration:** Week 1 — 2026-06-26 to 2026-07-02
...
4. Complete "More types" section (structs, pointers, slices, maps)
5. Open `projects/00-core-foundations/go/exercise01/main.go` and fill in the TODOs
...
- ❌ AI/ML work — Phase 3
- ❌ Docker/DevOps — Phase 6
- ❌ Capstone (ThanaweyaGPT) — Phase 7

---

## Weekly Success Criteria

- [ ] Go Tour completed (all sections)
- [ ] 2 Go exercises with tests passing
- [ ] Portfolio HTML scaffold with 3 pages
- [ ] First Git feature branch + PR created
...
| ID | Milestone | Due | Status |
|----|-----------|-----|--------|
| M1 | Go basics + mini exercises | Month 1 | In Progress |
| M2 | HTML/CSS/JS portfolio | Month 1 | In Progress |
| M3 | Git workflow mastery | Month 2 | Planned |
